...
describe("Ensure the rules component renders correctly", () => {
    ...
    test("Check that the rules render", () => {
        const rulesText = screen.getByTestId("rules-text")
        expect(rulesText).toHaveTextContent("Click a card to reveal an image. Then click another card to reveal that image. Your job is to remember the images and click two of the same cards. Good luck beating the highscore!")
    })
